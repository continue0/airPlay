...
public class GamePlane  extends JPanel { 
   ...
   // public static BufferedImage airplane0;
    ...
    private myPlane myplane = new myPlane(); // 我方机
    ...
    public static void main(String[] args) {
        ...
        GamePlane game = new GamePlane(); // 面板对象
    ...
    public void paintScore(Graphics g) {
        ...
        x += 290; // x坐标增290
        g.drawString("LIFE:" + myplane.getLife(), x, y); // 画命
    }
    ...
    public void shootAction() {
        ...
        if (shootIndex % 50 == 0) { // 300毫秒发一颗
            Bullet[] bs = myplane.shoot(); // 我机打出子弹
    ...
    public boolean isGameOver() {
        ...
        for (int i = 0; i < flyings.length; i++) {
            ...
            if (myplane.hit(obj)) { // 检查英雄机与飞行物是否碰撞
