...
public class myPlane extends JPanel { 
    ...
    private myAir hero = new myAir(); // 自己的飞机

    static { // 静态代码块，初始化图片资源
        try {
            background = ImageIO.read(myPlane.class.getResource("background.png"));
            start = ImageIO.read(myPlane.class.getResource("background.png"));
            airplane = ImageIO.read(myPlane.class.getResource("airplane.png"));
            bee = ImageIO.read(myPlane.class.getResource("bee.png"));
            ...
            pause = ImageIO.read(myPlane.class.getResource("pause.png"));
            gameover = ImageIO.read(myPlane.class.getResource("gameover.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
